...
const ShippingPanel = () => {
  ...
  return (
    <div className="shipping-container">
      ...
      {isLoading && activeShipments.length === 0 && <ShippingSkeleton />}
      {error && (
        <div
          style={{
        ...
        >
          ...
          >
            <div>
              <div style={{ fontSize: "14px", color: "var(--text-light)" }}>
                Sipariş No: #{selectedShipment.order_id}
              </div>
              <h2
                style={{
                  fontSize: "24px",
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              ...
              <div>
                ...
                <div style={{ fontWeight: "600" }}>
                  {selectedShipment.estimated_delivery || "Bilinmiyor"}
                </div>
              </div>
            </div>
            <div style={{ display: "flex", gap: "12px" }}>
            ...
            >
              ...
              <div
                style={{
                  ...
                  left: "0",
                  width:
                    selectedShipment.shipping_status === "Teslim Edildi"
                      ? "100%"
              ...
              {[
                ...
                },
                {
                  ...
                  status: ["Kargoya Verildi", "Yolda", "Teslim Edildi"],
                },
                { label: "Yolda", status: ["Yolda", "Teslim Edildi"] },
                { label: "Teslimat", status: ["Teslim Edildi"] },
              ].map((step) => {
                const isActive = step.status.includes(
                  selectedShipment.shipping_status,
                );
                return (
                  <div
          ...
          >
            ...
            >
              ...
              <button
                onClick={() =>
                  handleUpdateStatus(selectedShipment.order_id, "Yolda")
                }
              ...
              <button
                onClick={() =>
                  handleUpdateStatus(selectedShipment.order_id, "Teslim Edildi")
                }
